...
cp "${HOME}/.arduino15/packages/arduino/hardware/mbed_nano/4.2.4/cores/arduino/mbed/cmsis/CMSIS_5/CMSIS/TARGET_CORTEX_M"/* ${BASE_DIR}/third_party/cmsis/CMSIS/Core -a
